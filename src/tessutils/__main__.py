...
def createParser():
    ...
    mgorg.add_argument('-n', '--name', type=str, default=None, required=False, help='Optional name filter')
    ...
    mgcon.add_argument('-n', '--name', type=str, default=None, required=False, help='Optional name filter')
    ...
    mgcon = subparser.add_parser('all',  help="MongoDB all metadata check")
    mgcon.add_argument('-f', '--file', type=str, required=True, help='Input (for update) / Output (for list) CSV file')
    mgcon.add_argument('-n', '--name', type=str, default=None, required=False, help='Optional name filter')
    mgex1 = mgcon.add_mutually_exclusive_group(required=True)
